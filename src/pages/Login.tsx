      ...
      <div className="max-w-md mx-auto px-4 py-12">
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-morocco-blue">Welcome Back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              <input
                type="checkbox"
                id="remember"
                className="rounded border-gray-300 text-morocco-blue focus:ring-morocco-blue"
                checked={rememberMe}
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/register" className="text-morocco-blue hover:underline font-medium">
                Sign up
              </Link>
            </p>
          </div>
